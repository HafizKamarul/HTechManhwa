...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'The future of manhwa reading is here. Experience stories like never before with HTech Manhwa.'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'HTech Manhwa'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', 'The future of manhwa reading is here. Experience stories like never before with HTech Manhwa.'); ?>">
    ...
    <meta property="twitter:title" content="<?php echo $__env->yieldContent('title', 'HTech Manhwa'); ?>">
    <meta property="twitter:description" content="<?php echo $__env->yieldContent('description', 'The future of manhwa reading is here. Experience stories like never before with HTech Manhwa.'); ?>">
    <meta property="twitter:image" content="<?php echo e(asset('logo.png')); ?>">
    
    <title><?php echo $__env->yieldContent('title', 'HTech Manhwa'); ?></title>
    ...
    <link rel="preload" href="<?php echo e(asset('full_logo.png')); ?>" as="image">
    <link rel="preload" href="<?php echo e(asset('images/backgrounds/background.png')); ?>" as="image">
    ...
    <style>
        ...
        /* Background Image */
        body {
            background-image: url('<?php echo e(asset("images/backgrounds/background.png")); ?>');
...
<body class="text-gray-100 font-roboto">
    ...
    <nav class="border-b border-purple-500/20 bg-black/80 backdrop-blur-md fixed w-full z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('home')); ?>" class="flex items-center logo-container relative">
                            <img src="<?php echo e(asset('full_logo.png')); ?>" alt="HTech Manhwa Full Logo" class="h-10 md:h-12 lg:h-14 w-auto logo-glow max-w-xs relative z-10">
                        </a>
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <a href="<?php echo e(route('home')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('home') ? 'text-purple-400 bg-gray-800' : 'text-gray-300 hover:text-purple-400'); ?>">Home</a>
                            <a href="<?php echo e(route('manhwas.index')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('manhwas.*') ? 'text-purple-400 bg-gray-800' : 'text-gray-300 hover:text-purple-400'); ?>">Library</a>
                            <a href="<?php echo e(route('genres.index')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('genres.*') ? 'text-purple-400 bg-gray-800' : 'text-gray-300 hover:text-purple-400'); ?>">Genres</a>
                            <a href="<?php echo e(route('manhwas.index', ['sort' => 'latest'])); ?>" class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-purple-400">Updates</a>
                            <a href="<?php echo e(route('admin.index')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('admin.*') ? 'text-purple-400 bg-gray-800' : 'text-gray-300 hover:text-purple-400'); ?>">Admin</a>
                        </div>
                    </div>
            ...
            <div id="searchBar" class="hidden bg-black/90 backdrop-blur-md border-t border-purple-500/20">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <form method="GET" action="<?php echo e(route('manhwas.index')); ?>" class="flex">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center mb-4 logo-container relative">
                        <img src="<?php echo e(asset('full_logo.png')); ?>" alt="HTech Manhwa Full Logo" class="h-8 w-auto logo-glow max-w-48 relative z-10">
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('manhwas.index', ['sort' => 'popular'])); ?>" class="text-gray-400 hover:text-purple-400">Popular</a></li>
                        <li><a href="<?php echo e(route('manhwas.index', ['sort' => 'latest'])); ?>" class="text-gray-400 hover:text-purple-400">New Releases</a></li>
                        <li><a href="<?php echo e(route('genres.index')); ?>" class="text-gray-400 hover:text-purple-400">Genres</a></li>
                        <li><a href="<?php echo e(route('manhwas.index')); ?>" class="text-gray-400 hover:text-purple-400">Authors</a></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="text-gray-400"><?php echo e(\App\Models\Manhwa::count()); ?> Manhwa</li>
                        <li class="text-gray-400"><?php echo e(\App\Models\Chapter::count()); ?> Chapters</li>
                        <li class="text-gray-400"><?php echo e(\App\Models\Genre::count()); ?> Genres</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        function detectBackgroundLoaded() {
            ...
            img.src = '<?php echo e(asset("images/backgrounds/background.png")); ?>';
        }
...
<?php /**PATH D:\Laravel\HTechManhwa\resources\views/layouts/futuristic.blade.php ENDPATH**/ ?>